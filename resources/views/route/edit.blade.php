                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="name" class="form-control"
                                               value="{{ old('station_name', $route->name) }}">
                                    </div>
                                    @error('name')
                                ...
                                <div class="col-12">
                                    ...
                                    <div id="stations" class="row">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" id="add-station"
                                                    class="btn btn-primary btn-round float-right">Add
                                                Station
                                            </button>
                                        </div>
                                        @forelse(old('stations', $route->stations->pluck('id')) as $key => $stationL)
                                            <div class="col-md-4">
                                                {{--<label class="form-label">Station</label>--}}
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <button type="button"
                                                                class="btn btn-info m-0 px-2 move-station-up" @disabled($key == 0)>
                                                            <i class="nc-icon nc-minimal-up"></i>
                                                        </button>
                                                        <button type="button"
                                                                class="btn btn-info m-0 px-2 move-station-down" @disabled($key == count(old('stations', $route->stations->pluck('id'))) - 1)>
